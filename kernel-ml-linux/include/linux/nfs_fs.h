...
extern void set_trace_nfs4_readdone_fptr(void* fptr);
extern void set_trace_nfs4_read_fptr(void* fptr);
...
/*
 * FSL - NFS rsize update functions
 */
extern unsigned int nfs_get_current_rsize(void);
extern void nfs_set_current_rsize(unsigned int rsize);
