...
trace_readahead_fsl_writeback_dirty_page_fptr dirty_page_fptr = NULL;

void set_trace_readahead_fsl_writeback_dirty_page_fptr(void* fptr) {
        dirty_page_fptr = fptr;
}
EXPORT_SYMBOL(set_trace_readahead_fsl_writeback_dirty_page_fptr);
...
void account_page_dirtied(struct page *page, struct address_space *mapping)
{
	...
	trace_writeback_dirty_page(page, mapping);
        ...
        if (!(strcmp(syscall_name, "ksys_write") == 0)) {
          ...
          if (dirty_page_fptr != NULL) {
            dirty_page_fptr(page, inode);
          }
        }
        // FSL extension
